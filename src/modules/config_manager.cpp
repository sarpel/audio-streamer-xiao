...
bool config_manager_load(void)
{
    ...
    else
    {
        ...
        // Legacy configuration migration disabled - clean v2 schema implementation
        ESP_LOGW(TAG, "No legacy configuration found or migration disabled");
        return false;
    }
}
...
bool config_manager_reset_field(config_field_id_t field_id)
{
    ...
    {
        return config_manager_set_field(field_id, default_value, NULL);
    }
