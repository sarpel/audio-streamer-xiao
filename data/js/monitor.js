...
async function loadMonitoringData() {
    try {
        ...
        setElementText('monitor-min-heap', formatBytes(status.memory.min_free_heap));
        ...
        setElementText('monitor-wifi-connected', status.wifi.connected ? '✅ Yes' : '❌ No');
        setElementText('monitor-tcp-connected', status.tcp.connected ? '✅ Yes' : '❌ No');
        ...
        setElementText('monitor-buffer-size', formatBytes(status.buffer.size_kb * 1024));
